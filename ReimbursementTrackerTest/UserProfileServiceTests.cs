...
public class UserProfileServiceTests
{
    ...
    public void UpdateProfile_Success()
    {
        ...
        // Act
        var updatedProfile = userProfileService.Update(userProfileDTO);
    ...
    public void GetUserProfileByUsername_Success()
    {
        ...
        // Act
        var retrievedProfile = userProfileService.GetUserProifleByUsername("testUser");
    ...
    {
        // Act & Assert
        Assert.Throws<UserProfileNotFoundException>(() => userProfileService.GetUserProifleByUsername("nonexistentUser"));
    }
